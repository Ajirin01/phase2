            ...
            <div class="col-md-8">
                <div class="panel panel-default sombra_caja_producto">
                    <div class="panel-body">
                        <div class="clearfix">
                            <div class="pull-left">
                                <h3>Phase2 Point of Sale</h3>
                                <span>Sale and Stock Management</span>
                            </div>
                            <div class="pull-right"> 
                                <h1>@lang('SALE') #<span id="codigo">{{$data['sale_number']}}</span></h1>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="col-md-6 pull-left">
                                        <a class="tn btn-info btn-lg waves-effect btn-agregar" data-toggle="modal" id="agregar_productos" data-target=".bs-example-modal-lg"> @lang('Add') <i class="fa fa-plus-circle" ></i></a>
                                        <a class="tn btn-danger btn-lg waves-effect btn-agregar" data-toggle="modal" data-target="#modal_vaciar"> @lang('Empty') <i class="fa fa-trash" ></i></a>
                                    </div>
                                </div>

                                <div class="m-t-20 col-md-12 col-xs-12">
                                    {{-- <label for="cliente">@lang('idioma.pos_escoja_cli')</label> --}}
                                    <input id="cliente" type="hidden" name="cliente" value="{{rand(123456789,999999999)}}">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">&nbsp;</div>
                                <div class="col-md-12">
                                    <label for="pagoPrevio">@lang('Discount') (%)</label>
                                ...
                                <div class="col-md-12">&nbsp;</div>
                                <div class="col-md-12">
                                    <label for="FormaPago">@lang('Payment Method')</label>
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <a style="width:100%; padding-top:0.5em; padding-bottom: 0.5em; font-size: 18pt;"  href="javascript:void" class="btn btn-info waves-effect waves-light" id="pagar"> @lang('Pay Now') <i class="fa fa-credit-card"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-lg" style="width:80%">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="col-md-8">
                                <h4 class="modal-title" id="myLargeModalLabel">@lang('Add Products')</h4>
                                <small>@lang('The list shows the last 10 products registered in the system.')</small>
                            </div>
                            <div class="col-md-4">
                                <div class="col-sm-12">
                                    <input type="text" placeholder="@lang('product ID or Name')"class="form-control" name="buscar_producto" id="buscar_producto">
                                </div>
                            </div>
                        </div>
            ...
            <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                            <h4 class="modal-title">@lang('Add Product')</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly="readonly" class="form-control" id="codigo_proceso" value="{{$data['sale_number']}}">
                                    </div>
                                </div>
                            ...
                            <div class="row text-center">
                                <div class="col-md-12">
                                    <label for="total"class="text-left"><h2>@lang('idioma.pos_a_pagar') Naira</h2></label>
